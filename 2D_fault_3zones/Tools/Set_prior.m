...
switch Pr.n_fields
    case 3
        K(1).mean.lim=[log(1/3000),log(1/2000)]; 
        K(2).mean.lim=[log(1/900),log(1/700)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(3).mean.lim=[log(1/300),log(1/200)]; 
        K(1).per.nu = 1.5; K(1).per.sigma =0.0;
        K(2).per.nu = 1.5; K(2).per.sigma =0.0; %%constant for now
        K(3).per.nu = 1.5; K(3).per.sigma =0.0; %%constant for now
    case 2
