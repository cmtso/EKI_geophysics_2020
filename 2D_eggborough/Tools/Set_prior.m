...
switch Pr.n_fields
    case 3
        K(1).mean.lim=[log(1/400),log(1/200)]; 
        K(2).mean.lim=[log(1/180),log(1/120)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(3).mean.lim=[log(1/80),log(1/10)]; 
    ...
    case 2
        K(1).mean.lim=[log(1/800),log(1/150)]; %%%THIS IS THE BACKGROUND SIGMA (this is the value the conductivity takes outside zone 1).
        K(2).mean.lim=[log(1/100),log(1/1)]; 
